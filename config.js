...
export const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwl6OQvlEMAZdzpL-Xuq9NAWsSFBuZTAXgz4O51GM62HImSQ1bDSaaXEehqiF2phgmx/exec';

export const translations = {
    'en': {
        'app_title': 'Meat Stock Manager',
        ...
        'butchery_production': 'Butchery & Yield',
        ...
        'auto_backup_desc': 'Enable automatic backups to save a copy of your data periodically.',
        ...
        'supplier_opening_balance_desc': 'Set the initial amount owed to a supplier.',
        ...
        'restore_danger_text': 'This will permanently delete current data in selected sheets.',
        ...
        'data_refresh_fail_toast': 'Could not refresh data.',
        'backup_created_toast': 'Backup created: {fileName}',
        'backup_confirm_prompt': 'Create a full manual backup?',
        'auto_backup_updated_toast': 'Automatic backup settings updated!',
        'auto_backup_failed_toast': 'Failed to update settings.',
        'restore_select_sheet_toast': 'Select at least one sheet to restore.',
        ...
        'select_po_first_toast': 'Select a Purchase Order to receive stock.',
        ...
        'toggle_user_enable_confirm': 'Are you sure you want to enable this user?',
        'toggle_user_disable_confirm': 'Are you sure you want to disable this user?',
        ...
        'reject_confirm_prompt': 'Are you sure you want to reject this {type}?',
        'approved_toast': '{type} approved successfully!',
        'rejected_toast': '{type} rejected successfully!',
        'item': 'Item',
        'transfer_not_found_toast': 'Transfer not found.',
        'parent_item': 'Primal Cut (Parent)',
        ...
        'batch_assignment': 'New Batch #',
    },
    'ar': {
        'app_title': 'نظام إدارة مخزون اللحوم',
        ...
        'butchery_production': 'الجزارة والإنتاج',
        ...
        'cat_offal': 'أحشاء',
        'cat_processed': 'مصنعات/لحوم باردة',
        'cat_consumables': 'مستهلكات',
        ...
        'auto_backup_desc': 'قم بتمكين النسخ الاحتياطي التلقائي لحفظ نسخة من بياناتك بشكل دوري.',
        ...
        'supplier_opening_balance_desc': 'تعيين المبلغ الأولي المستحق للمورد.',
        ...
        'restore_danger_text': 'سيؤدي هذا إلى حذف البيانات الحالية نهائيًا في الأوراق المحددة.',
        ...
        'data_refresh_fail_toast': 'فشل تحديث البيانات.',
        'backup_created_toast': 'تم إنشاء النسخة الاحتياطية: {fileName}',
        'backup_confirm_prompt': 'إنشاء نسخة احتياطية يدوية كاملة؟',
        'auto_backup_updated_toast': 'تم تحديث إعدادات النسخ الاحتياطي التلقائي!',
        'auto_backup_failed_toast': 'فشل تحديث الإعدادات.',
        ...
        'toggle_user_enable_confirm': 'هل أنت متأكد من رغبتك في تمكين هذا المستخدم؟',
        'toggle_user_disable_confirm': 'هل أنت متأكد من رغبتك في تعطيل هذا المستخدم؟',
        ...
        'no_items_selected_toast': 'لم يتم تحديد أصناف.',
        ...
        'no_price_history': 'لا يوجد سجل أسعار.',
        ...
        'reject_confirm_prompt': 'هل أنت متأكد أنك تريد رفض {type}؟',
        'approved_toast': 'تمت الموافقة على {type} بنجاح!',
        'rejected_toast': 'تم رفض {type} بنجاح!',
        'item': 'الصنف',
        'transfer_not_found_toast': 'لم يتم العثور على التحويل.',
        'parent_item': 'القطعة الأساسية (الأصل)',
        'yield_results': 'نتائج الإنتاجية',
        'add_cuts': 'إضافة قطعيات',
        'process_production': 'معالجة الإنتاج',
        'weight_kg': 'الوزن (كجم)',
        'batch_number': 'رقم الدفعة / التشغيلة',
        'expiry_date': 'تاريخ الانتهاء',
        'batch_assignment': 'رقم دفعة جديد',
    }
};