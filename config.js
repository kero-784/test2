...
export const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycby9vpoGYXJAF4AWzisQZofHSOwg4WmKZguFwxgD6Sjzn2B3tpMR_V9SpXfkDrYA9PyT/exec';
...
export const translations = {
    'en': {
        ...
        'item_type': 'Item Type (Main/Cut)',
        'type_main': 'Main Unit (Parent/Carcass)',
        'type_cut': 'Cut / Sub-Item (Child)',
    ...
    'ar': {
        'app_title': 'ادارة قسم الجزارة',
        'login_prompt': 'الرجاء إدخال بيانات التسجيل الخاصة بك للمتابعة.',
        ...
        'dashboard': 'بيانات عامة',
        'stock_operations': 'حركات مخزنية',
        'butchery_production': 'الجزارة والإنتاج',
        'purchasing': 'اوامر التوريد',
        'requests': 'الطلبات',
        'payments': 'المدفوعات',
        'reports': 'التقارير',
        'stock_levels': 'الارصدة',
        ...
        'submit_payment_btn': 'إرسال الدفع',
        ...
        'receive_against_po': 'استلام بامر توريد',
        'optional': '(اختياري)',
        'select_a_po': 'اختر امر توريد',
        'to_branch': 'إلى فرع',
        ...
        'parent_item': 'الأصل (ذبيحة)',
        'weight_kg': 'وزن (كجم)',
        'batch_assignment': 'رقم تعريف جديد',
        'yield_results': 'الناتج',
        'add_cuts': 'إضافة قطعيات',
        'process_production': 'معالجة',
        'internal_transfer': 'تحويل',
        'send_stock_to_branch': 'تحويل داخلي',
        'from_branch': 'من فرع',
        ...
        'create_po': 'إنشاء امر توريد',
        'view_pos': 'عرض اوامر التوريد',
        'pending_approval': 'قيد الموافقة',
        'po_details': 'تفاصيل امر التوريد',
        'po_ref_no': 'رقم مرجع امر التوريد',
        'items_to_order': 'الأصناف المطلوبة',
        'po_list': 'قائمة طلبات الشراء',
        'table_h_po_no': 'رقم امر التوريد',
