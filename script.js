...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzTq4DNXofn5_hs7No-vF92xDO1LFSCoYHbelTpT5tzUxD87UTPGNIts0iUPaB6xTN9/exec';
    ...
    let state = {
        ...
        backups: [],
        reportSelections: {
            branchConsumption: { branches: new Set(), items: new Set() },
            sectionConsumption: { sections: new Set(), items: new Set() }
        },
    ...
    async function attemptLogin(username, loginCode) {
        ...
        if (!SCRIPT_URL || !SCRIPT_URL.includes('macros/s')) {
            const errorMsg = 'SCRIPT_URL is not set or invalid in script.js. Please deploy your script and paste the URL.';
