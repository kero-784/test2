...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbx3wq9J_EbdDkCl1_cKAFs1gFhy9FvvEGl03UtO_ZgNmbITCn5dnRZ4_nAWXMgZbov5/exec';
            ...
            group.children.forEach(item => {
                ...
                headers.forEach(header => {
                    switch (header) {
                        ...
                        case 'unit': itemsHtml += `<td>${fullItem.unit}</td>`; break;
    ...
    function applyUserUIConstraints() {
        ...
        const branchCode = state.currentUser.AssignedBranchCode;
        if (branchCode) {
            ['receive-branch', 'transfer-from-branch', 'return-branch', 'adjustment-branch', 'extraction-branch'].forEach(id => {
